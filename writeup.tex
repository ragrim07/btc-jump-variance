...
This is where most of the time went. The 40 moments are formulas I derived by
hand, and if one of them is wrong then everything downstream is quietly wrong
with it, in a way that no amount of staring at the output would reveal.
